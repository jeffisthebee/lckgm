...
export const teams = [
  ...
  { id: 5, name: 'DK', fullName: '디플러스 기아 (DK)', power: 86, description: '전략적 플레이와 팀워크', colors: { primary: '#00D9C4', secondary: '#FFFFFF' } },
  ...
  { id: 10, name: 'DNS', fullName: 'DN 수퍼스 (DNS)', power: 84, description: '신생 팀, 도전 정신', colors: { primary: '#1E3A8A', secondary: '#FFFFFF' } },
];

export const teamFinanceData = {
