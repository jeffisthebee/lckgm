...
function Dashboard() {
  ...
  const [prizeMoney, setPrizeMoney] = useState(0.0); // 상금
  ...
  // 1. 접속 불가 해결: 데이터가 로딩되지 않았거나 깨졌을 때 안전하게 처리
  ...
  // 1. 접속 불가 해결: 팀 정보 매칭 강화 (String 형변환으로 비교)
  // LocalStorage에 저장된 league.team.id와 const teams의 id 타입을 맞춰서 비교합니다.
