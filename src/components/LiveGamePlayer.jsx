    ...
    return (
      <div className="fixed inset-0 bg-gray-900 z-[200] flex flex-col text-white font-sans">
        ...
        <div className="bg-black border-b border-gray-800 flex flex-col shrink-0">
            ...
            <div className="min-h-24 py-2 flex flex-col sm:flex-row items-center justify-between px-4 sm:px-8 gap-2">
              ...
              <div className="flex flex-col items-center justify-center w-full sm:w-1/3 relative order-1 sm:order-2 mb-2 sm:mb-0">
                  {phase === 'DRAFT' ? (
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden">
            ...
            {phase === 'ROSTER_SELECTION' && (
                <div className="flex-1 flex flex-col items-center justify-start sm:justify-center bg-gray-900 p-4 sm:p-8 overflow-y-auto">
                    <h2 className="text-3xl font-black mb-2 text-center mt-4 sm:mt-0">선발 라인업 확정 (Roster Check)</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 w-full max-w-6xl h-auto sm:h-[70vh]">
                         ...
                         <div className="flex-1 bg-gray-900 rounded-xl p-6 border border-gray-700 overflow-y-auto min-h-[400px] sm:min-h-0">
            ...
            {phase === 'DRAFT' && (
             <div className="flex-1 flex flex-col sm:flex-row bg-gray-900 p-4 sm:p-8 gap-4 sm:gap-8 items-center justify-center relative overflow-hidden">
                 <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-red-900/20 pointer-events-none"></div>

                 {/* Blue Picks List */}
                 <div className="hidden sm:block w-1/4 space-y-4 z-10">
            ...
            {phase === 'GAME' && (
                ...
                <div className={`${mobileTab === 'BLUE' ? 'flex' : 'hidden'} sm:flex w-full sm:w-60 lg:w-80 bg-gray-900 border-r border-gray-800 flex-col pt-2`}>
                ...
                <div className={`${mobileTab === 'RED' ? 'flex' : 'hidden'} sm:flex w-full sm:w-60 lg:w-80 bg-gray-900 border-l border-gray-800 flex-col pt-2`}>
